...
export default function InvestmentCard({investment,index}) {
    return (
        <article className="investmentsPageProjectCard">
            ...
            <div className={`investmentsPageProjectCardAvailability investmentsPageProjectCardAvailability--${investment.available}`}>{investment.available?"Vigente":"Próximamente"}</div>
